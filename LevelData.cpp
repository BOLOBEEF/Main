...
struct Level
{
	...
	void Level2()
	{
		...
		isSnowLevel = false;
		fireBoy = Player(Fireboy, offset + Vector2f(332, 936));
		waterGirl = Player(Watergirl, offset + Vector2f(399, 937));
		...
		colliders.Add(Collider(Collider::ColliderType::Rectangle, center + offset + Vector2f(-640, 100), Vector2f(4, 4)));
